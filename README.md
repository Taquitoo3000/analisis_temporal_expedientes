...
En el cual se tiene un ID como `Expediente`. distintos tipos de Conclusión en los cuales puede terminar un expediente o en su defecto, estar aun sin concluir. Al inicio del código se establecen las condiciones iniciales como la zona a analizar, el tipo de conclusión a analizar y el periodo de tiempo a analisar, es decir, desde qué año a qué año:
```python
sub = 'A'              # zona A
conclusion = 'admis'   # Admisión
año_i = 2020
año_f = 2025
```
Se realizan los siguientes análisis
  ...
  2. **Distribución Acumulativa**: Distribución del porcentaje de expedientes concluidos en distintos años en función de los días hasta su conclusión
